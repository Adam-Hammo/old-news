...
async def get_package() -> str:
	return await pulumi.runtime.register_package(
		...
		package_name="healthchecksio",
		package_version=get_version(),
		base64_parameter="eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tyaXN0b2ZmZXJhaGwvaGVhbHRoY2hlY2tzaW8iLCJ2ZXJzaW9uIjoiMi4zLjAifX0=",
	)
