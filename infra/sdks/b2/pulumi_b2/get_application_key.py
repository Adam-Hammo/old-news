...
class GetApplicationKeyResult:
    ...
    def __init__(
        ...
        if expiration_timestamp and not isinstance(expiration_timestamp, float):
            raise TypeError("Expected argument 'expiration_timestamp' to be a float")
    ...
    def expiration_timestamp(self) -> _builtins.float:
...
def get_application_key_output(
...
) -> pulumi.Output[GetApplicationKeyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetApplicationKeyResult(
