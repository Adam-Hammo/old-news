...
def register(resource_modules, resource_packages):
    ...
    for mod_info in resource_modules:
        pulumi.runtime.register_resource_module(mod_info["pkg"], mod_info["mod"], Module(mod_info))
...
def lift_output_func(func: typing.Any) -> typing.Callable[[_F], _F]:
    ...
    def lifted_func(*args, opts=None, **kwargs):
        ...
        return pulumi.Output.from_input({"args": args_list, "kwargs": bound_args.kwargs}).apply(
            lambda resolved_args: func(*resolved_args["args"], opts=opts, **resolved_args["kwargs"])
        )
...
async def get_package() -> str:
    return await pulumi.runtime.register_package(
        ...
        package_name="logfire",
        package_version=get_version(),
        base64_parameter="eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3B5ZGFudGljL2xvZ2ZpcmUiLCJ2ZXJzaW9uIjoiMC4xLjE1In19",
    )
